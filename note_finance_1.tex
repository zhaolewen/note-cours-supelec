...
\end{equation}
$=>$ $C_{BS}$ est croissant et $P_{BS}$ est d\'ecroissant par rapport \`a $S$.
...
\begin{equation}
\Vega=\frac{\partial C_{BS}}{\partial \sigma} = \frac{\partial P_{BS}}{\partial\sigma}=Sn(d_1)\sqr{T-t}
\end{equation}
...
\begin{equation}
\Theta^c=\frac{\partial C_{BS}}{\partial t}=-\frac{Sn(d_1)\sigma}{2\sqrt{T-t}}-rKe^{-r(T-t)}N(d_2)<0
\end{equation}
\begin{equation}
\Theta^p=\frac{\partial P_{BS}}{\partial t}=-\frac{Sn(d_1)\sigma}{2\sqrt{T-t}}+rKe^{-r(T-t)}\mathcal{N}(-d_2)
\end{equation}
$=>$Le prix du call est d\'ecroissant par rapport au temps
...
\end{equation}
$=>$ call est croissant et le put est d\'ecroissant par rapport au taux d'int\'er\^et
\end{enumerate}
\end{document}
